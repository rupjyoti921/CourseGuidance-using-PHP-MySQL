...
<html lang="en">
  ...
  <div class='col-md-9'>
  <h4 style="text-align:center;background-color:skyblue;margin-top:5px"><b>Remove Courses</b></h4> 
...
<?php if(isset($_POST['filter_course'])){ ?>
  ...
  <table  class="table table-hover table table-bordered" style="text-align:center">
        ...
        <td><a href="remove_courses_code.php?course_code=<?php echo $row->course_code; ?>" style="color:white;" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="Remove Course" > <i  class="fa fa-trash-o" style="font-size:20px;padding:3px"></i></a></td>
        </tr>  
        <?php $x++ ;   
            }    ?>
    </table>
