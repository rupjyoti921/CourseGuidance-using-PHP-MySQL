...
//code for insertion of course details
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $entryquery = "INSERT INTO course_details (standard,course_title,course_code,course_description) VALUES('$standard','$course_title','$course_code','$course_description')";
...
<html lang="en">
  ...
  <div class='col-md-9'>
  <h4 style="text-align:center;background-color:skyblue;margin-top:5px;color:black"><b>New Entry</b></h4>
  ...
  <form class="form-horizontal" style="padding:7px" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" autocomplete="off">
       ...
       <input type="text" class="form-control"  placeholder="Enter Your Course Title" name="course_title" required />
       </div> <br>

       <div class="form-group">
       <label for="course Code"><b>Course Code :</b></label>
       <input type="text" class="form-control"  placeholder="Enter Your Course Code" name="course_code" required />
       </div> <br>

       <div class="form-group">
       <label for="course description"><b>Course Description </b>(Within 3000 characters) <b>:</b></label>
       <textarea  rows="10"  name="course_description" style="width:100%" placeholder="Enter Course Description" required></textarea>
      </div> 

     <button  type="submit" style="float:right;margin-right:20px" name="newentry" class="btn btn-success">Submit</button>
