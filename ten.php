...
//coding for extract course data after class 10th
$query="SELECT * FROM course_details WHERE standard='After_10th' ORDER BY course_title ASC ";
...
<html lang="en">
  <head>
    ...
    <title>Courses after 10th</title>
...
<div class="col-md-8"><h3 style="text-align:center;background-color:#3ceb3e;">Select Courses after class 10th</h3><hr></div>
<div class="col-md-2"></div>
</div>      
...
<table class="table table-hover">
    ...
    <?php 
        while($row=mysqli_fetch_object($result)){
          ?>
      <tr>
        <td style="font-size:20px;color:black;"><a style="color:black;text-decoration: none;" href="ten.php?course_code=<?php echo $row->course_code; ?>" ><?php echo $slno ; echo ". " ; echo $row->course_title; ?></a></td>
      </tr>
      <?php 
      $slno++;
       }  ?>
