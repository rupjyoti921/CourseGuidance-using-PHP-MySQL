<nav class="navbar navbar-expand-lg navbar-light " style="background-color: white; font-size: 18px;">
    ...
    <a  id="fontcolor" class="navbar-brand" href="home.php"> Home  <i class="bi bi-house-door"></i></a>
      ...
      <ul class="navbar-nav ms-auto my-0 my-lg-0 navbar-nav-scroll " style="--bs-scroll-height: 100px;">
          ...
          <a class="dropdown-item" style="text-decoration:none;"><center><i class="bi bi-person-check-fill"></i>&nbsp;&nbsp;<?php if(isset($_SESSION['email_address'])){echo $_SESSION['full_name'];} ?></center> </a>
          ...
          <li class="nav-item"> 
            <a  id="fontcolor" class="nav-link active" aria-current="page" style="cursor: pointer;" onclick="callgetstarted()">Get Started  <i class="bi bi-emoji-laughing"></i> </a>
          </li>
          <li class="nav-item">
            <a  id="fontcolor" class="nav-link active" href="#">About us  <i class="bi bi-people"></i></a>
          </li>
          <li class="nav-item">
            <a id="fontcolor"  class="nav-link active"  href="contact_us.php">Contact us  <i class="bi bi-chat-dots"></i></a>
          </li>
          <li class="nav-item">
            <a id="fontcolor" class="nav-link active"  href="#">Help  <i class="bi bi-question-circle"></i></a>
          </li>
         

          <!-- below 6 li is only for space -->
          <!-- <li class="nav-item">
