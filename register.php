            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="regdata.php" class="register-form" id="register-form">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="index.php" class="signup-image-link" style="font-size:18px"><b>I have already an account</b></a>
                    </div>
                </div>
            </div>
        </section>
